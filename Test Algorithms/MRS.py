...
class MultiObjectiveRandomSearch(NSGA2):

    def _infill(self):
        return self.initialization.sampling.do(self.problem, self.pop_size)


problem = get_problem("zdt1")

algorithm = MultiObjectiveRandomSearch(pop_size=100)
